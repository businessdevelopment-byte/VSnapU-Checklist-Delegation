...
export default function QuickTask() {
  ...
  const fetchCurrentUser = useCallback(async () => {
    try {
      ...
      const whatsappSheetUrl = `https://docs.google.com/spreadsheets/d/${CONFIG.SHEET_ID}/gviz/tq?tqx=out:json&sheet=${CONFIG.WHATSAPP_SHEET}&headers=1`;
  ...
  const fetchChecklistData = useCallback(async () => {
    ...
    try {
      ...
      const checklistUrl = `https://docs.google.com/spreadsheets/d/${CONFIG.SHEET_ID}/gviz/tq?tqx=out:json&sheet=${CONFIG.CHECKLIST_SHEET}&headers=1`;
      ...
      if (data?.table?.rows) {
        const rows = data.table.rows; // Headers already skipped
  ...
  const fetchDelegationData = useCallback(async () => {
    ...
    try {
      ...
      const delegationUrl = `https://docs.google.com/spreadsheets/d/${CONFIG.SHEET_ID}/gviz/tq?tqx=out:json&sheet=${CONFIG.DELEGATION_SHEET}&headers=1`;
